...
window.GameManager = class {
    ...
    nextAsk() {
        hideButtonNext();
        if (this.awaitIn === "error") {
            this.askManager.nextAsk();
        } else if (this.awaitIn === "success") {
            hideOptions();
            hideTitles();
            hideFondoClip();            
            this.askManager = null;
