...
const Explanation = ({ follow }) => 
 <WithBackground background={Background} > 
  <div className="animate__animated animate__fadeIn enFrame">
    <Logo />
    <div className="topics col-10">
      <p className="topics-description">Decidí el destino de tu país respondiendo preguntas de los otros</p>
